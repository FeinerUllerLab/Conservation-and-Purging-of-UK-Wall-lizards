...
-stats ${savedir}/All_Polarised_Annotated_Tiberius.html -csvStats ${savedir}/All_Polarised_Annotated_Tiberius.csv \
${Genome_Database} ${savedir}/All_Polarised_Purging_tmp.vcf.gz > ${savedir}/All_Polarised_annotated_Tiberius.vcf

bgzip ${savedir}/All_Polarised_annotated_Tiberius.vcf
bcftools index --tbi ${savedir}/All_Polarised_annotated_Tiberius.vcf.gz 
