...
# Objective:  Array for Genotyping and hard-filtering in French-orign samples 
...
# Hard-Filtering for SNPs - Include QUAL and QD expressions /  Dp estimated by #samples (14 french) x Desired covergae (11x to 44x)
...
# Hard-Filtering for invariant sites - Remove QUAL and QD expressions /  Dp estimated by #samples (14 french) x Desired covergae (11x to 44x)
